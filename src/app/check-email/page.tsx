    ...
    <div className="min-h-screen bg-[#0C1220] flex items-center justify-center p-6">
      <div className="w-full max-w-md text-center">
        ...
        <div className="card p-8">
          ...
          <h1 className="font-display text-2xl font-semibold text-[#F4F1ED] mb-2">
            Check your inbox
          </h1>

          <p className="text-sm text-[#D4A373] mb-1">
            We sent a confirmation link to
          </p>

          {email && (
            <p className="text-sm font-medium text-[#F4F1ED] mb-6">{email}</p>
          )}

          {!email && (
            <p className="text-sm text-[#D4A373] mb-6">your email address.</p>
          )}
    ...
    <Suspense
      fallback={
        <div className="min-h-screen bg-[#0C1220] flex items-center justify-center">
          <div className="text-[#D4A373] text-sm">Loading...</div>
        </div>
      }
    >
      <CheckEmailContent />
